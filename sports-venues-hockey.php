    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <h4>7. HOCKEY </h4>
                <p>This competition will be held at Stadium Hockey MBMB Bukit Serindit </p>
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/hockey1.jpg" alt="">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/hockey2.jpg" alt="">
                    </div>
                </div>    
                <p>Bukit Serindit located in the Central Melaka. This hockey stadium was under Majlis Bandaraya Melaka Bersejarah administration </p>
                <p>MBMB Hockey Stadium have 2 hockey field and is able to accommodate 1000 audience at one time </p>
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/hockey3.jpg" alt="">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/hockey4.jpg" alt="">
                    </div>
                </div>    
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="list-unstyled thumblist">
                                ...
                                <li><a class="active" href="sports-venues-hockey.php">
