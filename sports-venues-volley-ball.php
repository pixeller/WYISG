    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <h4>10. VOLLEYBALL </h4>
                <p>This competition will be held at SMK Yok Bin </p>
                <div class="row">    
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/volleyball1.jpg" alt="">
                    </div>
                     <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/volleyball2.jpg" alt="">
                    </div>
                </div>
                <p>This venue have 2 courts which 1 court indoor and the other is open space court (roofless court) </p>
                <p>This venue have 2 courts which 1 court indoor and the other is open space court (roofless court) </p>
                <p>Amenities such as prayer room, cafeteria, changing rooms and toilets. </p>
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/volleyball3.jpg" alt="">
                    </div>
                     <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/volleyball4.jpg" alt="">
                    </div>
                </div>
                <div class="row">    
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/volleyball5.jpg" alt="">
                    </div>
                     <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="list-unstyled thumblist">
                                ...
                                <li><a class="active" href="sports-venues-volley-ball.php">
