    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <h4>11. VENUE </h4>
                <p>This competition will be held at Dewan Bola Keranjang Bukit Serindit </p>
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/venue1.jpg" alt="">
                    </div>
                </div>
                    
                <p>Bukit Serindit located in the Central Melaka. This hall was under Majlis Bandaraya Melaka Bersejarah administration </p>
                <div class="row">    
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/venue2.jpg" alt="">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/venue3.jpg" alt="">
                    </div>
                </div>    
