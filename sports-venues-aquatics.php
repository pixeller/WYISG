    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <h4>3. AQUATICS </h4>
                <p>This competition will be held at Hang Jebat Aquatic Centre </p>
                <div class="row">    
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/aquatics1.jpg" alt="">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/aquatics2.jpg" alt="">
                    </div>
                </div>    
                <p> Hang Jebat Aquatic Center starts it operation in March 2010 and was approved by the prescribed minimum Federation Internationale de Natation (FINA) </p>
                <p> It is located in Hang Jebat Sports Complex with capacity of 2000 people at one time. </p>
                <p> Among the facilities that are available at the Hang Jebat Aquatic Centre are two pools (swimming and diving), dressing rooms, treatment rooms, judges rooms, marshall room, media room, competition control room, meeting rooms, prayer rooms, VIP rooms, VIP stage, drug testing room, competition manager room, cafeteria and parking is convenient. </p>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/aquatics3.jpg" alt="">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="images/venue-john/aquatics4.jpg" alt="">
                    </div> 

                <p>&nbsp;</p>
                <div class="google-maps">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3986.6358854767095!2d102.23231509999997!3d2.2885990000000174!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d1fadff925bac1%3A0xc5e6407666c0cd02!2sHang+Jebat+Stadium!5e0!3m2!1sen!2s!4v1435513903011" width="600" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>     
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="list-unstyled thumblist">
                                ...
                                <li><a class="active" href="sports-venues-aquatics.php">
